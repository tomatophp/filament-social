...
namespace TomatoPHP\FilamentSocial\Filament\Actions;
...
class SocialShareAction extends Action
{
    ...
    protected string|Closure|null $shareUrl = null;

    protected string|Closure|null $shareTitle = null;
    ...
    /**
     * The url shared to the networks, defaults to the current page. Closures receive the table `$record`.
     */
    public function shareUrl(string|Closure|null $url): static
    {
        $this->shareUrl = $url;
    ...
    public function shareTitle(string|Closure|null $title): static
    {
    ...
    {
        return $this->evaluate($this->shareUrl);
    }

    public function getShareTitle(): ?string
    {
        return $this->evaluate($this->shareTitle);
    }
